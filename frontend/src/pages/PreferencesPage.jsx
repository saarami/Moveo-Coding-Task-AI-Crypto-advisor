...
import { Newspaper, TrendingUp, Sparkles, Smile, ArrowRight, AlertCircle } from 'lucide-react'
    ...
    >
      ...
      <div className="onboarding-body">
        <div className="onboarding-heading">
          <h1 className="onboarding-title">Preferences</h1>
          <p className="onboarding-subtitle">
            Update your interests. Content priority order affects your dashboard layout.
          </p>
        </div>
            ...
            <div className="chip-grid">
              {INVESTOR_TYPES.map(({ value, label }) => (
                <button
                  ...
                  onClick={() => { setInvestorType(value); clearFeedback() }}
                >
                  {label}
                </button>
              ))}
